...
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
    ...
    <ul class="navbar-nav">
      ...
      <div class="dropdown-menu">
         <a class="dropdown-item active" href="mwb-overview.html"> MWB Overview</a>
  ...
  $i=0;
   ...
   $sql="SELECT * FROM cover_photo WHERE category ='soft_lunch' AND year = '2024' ORDER BY id ASC";
  $result = mysqli_query($db,$sql);
   while ($row = mysqli_fetch_array($result)) {
          
        echo "<div class='col-md-2'>";
         echo " <div class='photoGallery'>";
        echo "<a href='admin/image/mwb2023/".$row["filename"]."' class='fancybox' data-fancybox='{$row['category']}' data-caption='{$row['title']}' data-id='{$row['id']}' >

               <img src='admin/image/mwb2023/".$row["filename"]."' class='w-100 shadow-1-strong img-fluid rounded mb-4' style='max-width:100%;'' />
