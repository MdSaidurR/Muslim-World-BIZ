 ...
 // Validate user company name
  ...
  if (empty($_POST["other"])) {
    ...
    if($_POST){
        ...
        $sql = "INSERT INTO businessmatching ( title,name,designation,email,code,phone,company,registration,profile,industry,status,cluster,address1,address2,city,postcode,state,country,country_code,company_phone) VALUES ( '$title','$name','$designation','$email','$code','$phone','$company','$registration','$profile','$industry','$status','$cluster','$address1','$address2','$city','$postcode','$state','$country','$country_code','$company_phone')";
...
<form action="appsaya.php" method="post">
