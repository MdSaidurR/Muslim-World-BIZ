...
$fromemail =  $email;
$subject="INTERNATIONAL DELEGATE REGISTRATION";
...
$toemail="info@muslimworldbiz.com";  
if(mail($toemail, $subject, $email_message, $headers)){
   $statusMsg= "Congratulations! Your requst has been sent successfully.";
}else{
