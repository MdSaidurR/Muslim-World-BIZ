...
$search_keyword = '';
  ...
  $sql = 'SELECT * FROM AAAAA WHERE id LIKE :keyword OR slug LIKE :keyword OR author LIKE :keyword ORDER BY id DESC ';
...
<div class="nav-container">
  ...
  ?>
    ...
    <td><?php    
                      ...
                      echo "<a href='brief-news-details.php?id={$row['id']}/{$row['slug']}' title='Update Record' data-toggle='tooltip'><span class='fa fa-eye'></span></a>";
                        echo "<a href='update-brief-news.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='fa fa-edit'></span></a>";
