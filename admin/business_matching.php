...
$search_keyword = '';
  ...
  $sql = 'SELECT * FROM businessmatching WHERE id LIKE :keyword OR client_type LIKE :keyword OR  title LIKE :keyword OR name LIKE :keyword  OR designation LIKE :keyword OR email LIKE :keyword OR country LIKE :keyword ORDER BY id DESC ';
...
<div class="nav-container">
  ...
  ?>
    ...
    <td><?php echo $row['mobile_code']; ?><?php echo $row['mobile_number']; ?> </td>
    ...
    <td><?php echo $row['country_code']; ?> <?php echo $row['company_phone']; ?></td>
    <td><?php echo $row['interested_field']; ?>,<?php echo $row['other']; ?> </td>
...
<?php echo $per_page_html; ?>
        ...
        <br />
    <form method="post" action="business_matching_export.php">
