...
$search_keyword = '';
  ...
  $sql = 'SELECT * FROM trade_buyer WHERE id LIKE :keyword OR  title LIKE :keyword OR name LIKE :keyword  OR designation LIKE :keyword OR email LIKE :keyword OR country LIKE :keyword ORDER BY id DESC ';
...
<?php echo $per_page_html; ?>
        ...
        <br />
    <form method="post" action="trade_buyer_export.php">
