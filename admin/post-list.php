...
$search_keyword = '';
  ...
  $sql = 'SELECT * FROM all_news WHERE id LIKE :keyword OR slug LIKE :keyword OR author LIKE :keyword OR category LIKE :keyword OR position LIKE :keyword ORDER BY id DESC ';
...
<div class="nav-container">
  ...
  <a href="create_post.php" class="btn btn-success">Add New Post</a>
  ...
  ?>
    ...
    <td><?php    
                      ...
                      echo "<a href='details.php?id={$row['id']}/{$row['slug']}' title='Update Record' data-toggle='tooltip'><span class='fa fa-eye'></span></a>";
                        echo "<a href='update-post.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='fa fa-edit'></span></a>";
                      

                      echo "<a href='delete-post.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='fa fa-trash'></span></a>";
