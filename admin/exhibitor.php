...
$search_keyword = '';
  ...
  $sql = 'SELECT * FROM exhibitor WHERE id LIKE :keyword  OR  title LIKE :keyword OR name LIKE :keyword  OR designation LIKE :keyword OR email LIKE :keyword OR country LIKE :keyword ORDER BY id DESC ';
...
<div class="nav-container">
  ...
  ?>
    ...
    <td><?php echo $row['interested_booking']; ?></td>
...
<?php echo $per_page_html; ?>
        ...
        <br />
    <form method="post" action="exhibitor_export.php">
