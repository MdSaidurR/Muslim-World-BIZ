...
$search_keyword = '';
  ...
  $sql = 'SELECT * FROM cover_photo WHERE id LIKE :keyword OR title LIKE :keyword ORDER BY id DESC ';
...
<div class="nav-container">
  ...
  <a href="add_new_coverphoto.php" class="btn btn-success">Add New Post</a>
  ...
  ?>
    ...
    <td><?php    
     ...
     echo "<a href='update_coverphoto.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip'><span class='fa fa-edit'></span></a>";
    
     echo "<a href='delete-coverphoto.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='fa fa-trash'></span></a>";
