...
$search_keyword = '';
  ...
  $sql = 'SELECT * FROM media_partner WHERE id LIKE :keyword OR name LIKE :keyword OR company LIKE :keyword OR designation LIKE :keyword OR country LIKE :keyword OR email LIKE :keyword OR telephone LIKE :keyword OR mobile LIKE :keyword OR readership LIKE :keyword ORDER BY id DESC ';
...
<div class="nav-container">
  ...
  ?>
    ...
    <td><?php echo $row['readership']; ?></td>
    <td> <a href='<?php echo $row['website']; ?>'  target='_blank' > View</a></td>
    <td><?php echo $row['date']; ?></td>
    
    <td><?php    

                      echo "<a href='brief-news-details.php?id={$row['id']}' title='Update Record' data-toggle='tooltip'><span class='fa fa-eye'></span></a>";

                      echo "<a href='delete-brief-news.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='fa fa-trash'></span></a>";
...
<?php echo $per_page_html; ?>
        ...
        <br />
    <form method="post" action="media_partner_export.php">
