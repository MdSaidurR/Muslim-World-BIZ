...
$title=$name =$designation = $email =$mobile_code=$mobile_number=$booth=$objective=$objective_other=$company=$registration=$profile=$industry=$status=$cluster=$address1=$address2=$city=$postcode=$state=$country=$country_code=$company_phone=$industry_type=$other=$email_duplicale="";

$titleErr=$nameErr =$designationErr= $emailErr =$mobile_codeErr=$mobile_numberErr=$companyErr=$registrationErr=$profileErr=$industryErr=$address1Err=$cityErr=$postcodeErr=$stateErr=$countryErr=$country_codeErr=$company_phoneErr="";
...
// Validate user designation
    ...
    $mobile_codeErr = "Country code is required";
  } else {
   ...
   if(empty($_POST["mobile_number"])){
        ...
        $mobile_number = filterPhone($_POST["mobile_number"]);
        if($mobile_number == FALSE){
            $mobile_numberErr = "Invalid format";
        }
    }
  ...
  if (empty($_POST["objective"])) {
   ...
   if (empty($_POST["objective_other"])) {
    $objective_other= "";
  } else {
...
if(  empty($titleErr) && empty($nameErr) && empty($emailErr) && empty($mobile_codeErr) && empty($mobile_numberErr)  && empty($designationErr) && empty($companyErr) && empty($registrationErr) && empty($profileErr) && empty($industryErr) && empty($address1Err) && empty($cityErr) && empty($postcodeErr) && empty($stateErr) && empty($countryErr) && empty($country_codeErr) && empty($company_phoneErr)){
 // Prepare an insert statement
      
$sql = "SELECT * FROM exhibitor WHERE email='$email' AND event_number='$event_number'";
 $results = mysqli_query($link, $sql);
    ...
    $interested_booking=implode(",", $booth);
    $primary_objective=implode(",", $objective);
    $interested_field=implode(",", $industry_type);
    $sql = "INSERT INTO exhibitor ( title, name ,designation ,email, mobile_code , mobile_number,interested_booking,primary_objective,objective_other,company, registration, profile, industry, status , cluster, address1, address2, city, postcode, state , country , country_code, company_phone, interested_field, other , event_number) VALUES (?,?,?, ?, ?, ?,?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?,?,?)";
         
  if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
     mysqli_stmt_bind_param($stmt, "ssssssssssssssssssssssssss", $param_title,  $param_name , $param_designation , $param_email,  $param_mobile_code ,  $param_mobile_number,$param_interested_booking, $param_primary_objective, $param_objective_other,$param_company,  $param_registration,  $param_profile,  $param_industry,  $param_status ,  $param_cluster,  $param_address1,  $param_address2,  $param_city,  $param_postcode,$param_state ,  $param_country ,  $param_country_code,  $param_company_phone,  $param_interested_field,  $param_other ,  $param_event_number);
           ...
           $param_email =$email;
           $param_mobile_code =$mobile_code;
           $param_mobile_number =$mobile_number;
           $param_interested_booking = $interested_booking;
           $param_primary_objective = $primary_objective;
           $param_objective_other =$objective_other;
           ...
           $param_company_phone =$company_phone;
           $param_interested_field =$interested_field;
           $param_other =$other;
 ...
 <nav class="navbar navbar-expand-lg fixed-top" >
  ...
  <li class="nav-item">
   ...
   <li class="nav-item dropdown">
    ...
    <div class="container">
   <div class="contact">
  <img  class="img-fluid" src="image/coverphoto/exibitor-24.jpg" alt="mwb-2024" >
...
<div class="row">
    ...
    <div class="col-md-6">
          ...
          <div class="row">
            ...
            <div class="col-3">
              <select name="mobile_code" style="height:30px; border: 1px solid #000f89; font-size:13px;" >  <b class="error">*</b>
   ...
   </select> <span class="error"><?php echo $mobile_codeErr; ?></span>
            </div>

    <div class="col-7">
        <p>
        <input type="text" name="mobile_number" id="inputMobile_number" value="<?php echo $mobile_number; ?>">
 ...
 <label for="input"><b>I AM INTERESTED IN BOOKING</b><b class="error">*</b></label><br>
<div class="row">
   <div class="col-md-6">
      <input type="checkbox" name="booth[]" value="SHELL SCHEME BOOTH" />
   ​   <span class="checkmark"></span>
      <label class="special">SHELL SCHEME BOOTH</label>
   </div>

   <div class="col-md-6">
      <input type="checkbox" name="booth[]" value="BARE SPACE" /> 
    ​  <span class="checkmark"></span>
      <label class="special">BARE SPACE</label>
   </div>
  </div>

   <label for="input"><b>PRIMARY OBJECTIVE FOR EXHIBITING</b><b class="error">*</b></label><br>


<div class="row">
    <div class="col-md-3">
      <input type="checkbox" name="objective[]" value="PROMOTE PRODUCTS/SERVICES" />
   ​   <span class="checkmark"></span>
      <label class="special">Promote Products/services</label>
    </div>

   <div class="col-md-3">
       <input type="checkbox" name="objective[]" value="MEET TRADE BUYERS" /> 
    ​   <span class="checkmark"></span>
       <label class="special">Meet Trade Buyers</label>
   </div>

   <div class="col-md-3">
       <input type="checkbox" name="objective[]" value="FIND INVESTORS " /> 
    ​   <span class="checkmark"></span>
       <label class="special">Find Investors</label>
   </div>

   <div class="col-md-3">
     <input type="checkbox" name="objective[]" value="PERFORM DIRECT TRANSACTIONS " />
   ​  <span class="checkmark"></span>
     <label class="special">Perform Direct Transactions </label>
  </div> 

  <div class="col-md-3">
     <input type="checkbox" name="objective[]" value="LAUNCH NEW PRODUCTS/SERVICES" /> 
    ​ <span class="checkmark"></span>
     <label class="special">Launch New Products/services</label>
   </div>

   <div class="col-md-3">
     <input type="checkbox" name="objective[]" value="PARTNER WITH AGENTS/DISTRIBUTORS  " /> 
    ​ <span class="checkmark"></span>
     <label class="special">Partner With Agents/distributors </label>
   </div> 

   <div class="col-md-6">
     <input type="checkbox" id="Objective"  onClick="myFunction1()" />
    <label class="special">Others</label>
     <p id="text1" style="display:none">
    <input type="text" placeholder="Please State" name="objective_other"></p>
     </label>
 ...
 <label for="inputStatus">STATUS</label>
  <input type="text" name="status" value="<?php echo $status; ?>">
   ...
   <div class="col-md-4">
    <p>
 <label for="inputStatus">CLUSTER</label>
 ...
 <div class="col-md-6">
  ...
  <div class="row">
   ...
   <div class="col-md-3"> 
    <input type="checkbox" name="industry_type[]" value="Cosmetics" /> 
    ​ <span class="checkmark"></span>
   <label class="special">Cosmetics</label>
     </div>

      <div class="col-md-3"> 
    <input type="checkbox" name="industry_type[]" value="Management and service" /> 
    ​ <span class="checkmark"></span>
   <label class="special">Management and service</label>
     </div>

<div class="col-md-3"> 
    <input type="checkbox" name="industry_type[]" value="Government agency " /> 
    ​ <span class="checkmark"></span>
   <label class="special">Government agency </label>
</div>

<div class="col-md-3"> 
    <input type="checkbox" name="industry_type[]" value="Trading " /> 
    ​ <span class="checkmark"></span>
   <label class="special">Trading </label>
</div>

<div class="col-md-3">
    <input type="checkbox" name="industry_type[]" value="FOOD AND BEVERAGES" /> 
    ​ <span class="checkmark"></span>
...
<div class="col-md-3">
    ...
    <input type="checkbox" name="industry_type[]" value="TEXTILE" /> 
    ​ <span class="checkmark"></span>
...
<div class="col-md-3">
    ...
    <input type="checkbox" name="industry_type[]" value="E-commerce" /> 
    ​ <span class="checkmark"></span>
...
<div class="col-md-3">
    ...
    <input type="checkbox" name="industry_type[]" value="Medical & Pharmaceutical" /> 
    ​ <span class="checkmark"></span>
...
<div class="col-md-3">
    <input type="checkbox" name="industry_type[]" value="Information Technology" /> 
    ​ <span class="checkmark"></span>
...
<div class="col-md-3">
    ...
    <input type="checkbox" name="industry_type[]" value="Agriculture" /> 
    ​ <span class="checkmark"></span>
...
<div class="col-md-3">
    ...
    <input type="checkbox" name="industry_type[]"  value="Insurance and Banking" /> 
    ​ <span class="checkmark"></span>
   <label class="special"> Insurance and Banking</label>
    ...
    <input type="checkbox" name="industry_type[]" value="Education" /> 
    ​ <span class="checkmark"></span>
   ...
   <div class="col-md-3">
    ...
    <input type="checkbox" name="industry_type[]" value="Tourism" /> 
    ​ <span class="checkmark"></span>
...
<div class="col-md-3">
    ...
    <input type="checkbox" name="industry_type[]" value="Beauty & Wellness" /> 
    ​ <span class="checkmark"></span>
...
function myFunction1() {
  var checkBox = document.getElementById("Objective");
