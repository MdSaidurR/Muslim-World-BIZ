 ...
 <nav class="navbar navbar-expand-lg  fixed-top" >
  ...
  <li class="nav-item">
   ...
   <li class="nav-item dropdown">
    ...
    <div class="container">
   <img  class="img-fluid" src="image/coverphoto/international.jpg" alt="mwbiz-9" ><br><br>
    <div class="row">
  <div class="col-md-8">
...
<form action="international-registration-success.php" method="post" enctype="multipart/form-data">
     <p>
...
<option value="Dr">Dr</option>
 ...
 <textarea name="address" style="border:1px solid #000f89; border-radius:0px;" id="inputComment" class="form-control" required=""  rows="1" cols="53"></textarea>
        ...
        <div class="col-md-4">
          ...
          <div class="form-group">
 <label for="inputName">COUNTRY <b class="error">*</b></label>
...
<option value="1 : USD350">1 &nbsp: USD350</option>
<option value="2 : USD600">2 &nbsp: USD600 </option>
<option value="3 : USD950">3 &nbsp: USD950</option>
<option value="4 : USD1000">4 &nbsp: USD1000</option>
<option value="5 : USD1350">5 &nbsp: USD1350</option>
<option value="6 : USD1600">6 &nbsp: USD1600</option>
<option value="7 : USD1950">7 &nbsp: USD1950</option>
<option value="8 : USD2000">8 &nbsp: USD2000</option>
<option value="9 :USD2350">9 &nbsp: USD2350</option>
 <option value="10 : USD2600">10: USD2600</option>
</select>
    </div>
   </div><br>
    <div class="row">
