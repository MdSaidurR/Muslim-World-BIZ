...
$title=$name =$designation = $email =$mobile_code=$mobile_number=$company=$registration=$profile=$industry=$status=$cluster=$address1=$address2=$city=$postcode=$state=$country=$country_code=$company_phone=$industry_type=$other=$email_duplicale="";
...
$sql = "SELECT * FROM trade_buyer WHERE email='$email' AND event_number='$event_number'";
 $results = mysqli_query($link, $sql);
    ...
    $sql = "INSERT INTO trade_buyer ( title, name ,designation ,email, mobile_code , mobile_number, company, registration, profile, industry, status , cluster, address1, address2, city, postcode, state , country , country_code, company_phone, interested_field, other , event_number) VALUES (?, ?, ?, ?,?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?,?, ?, ?, ?, ?, ?,?)";
         
  if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
     mysqli_stmt_bind_param($stmt, "sssssssssssssssssssssss", $param_title,  $param_name , $param_designation , $param_email,  $param_mobile_code ,  $param_mobile_number,  $param_company,  $param_registration,  $param_profile,  $param_industry,  $param_status ,  $param_cluster,  $param_address1,  $param_address2,  $param_city,  $param_postcode,$param_state ,  $param_country ,  $param_country_code,  $param_company_phone,  $param_interested_field,  $param_other ,  $param_event_number);
...
<body >
 <nav class="navbar navbar-expand-lg fixed-top" >
  ...
  <li class="nav-item">
    ...
    <div class="container">
   <div class="contact">
     <img  class="img-fluid" src="image/coverphoto/tradeb-24.jpg" alt="TB2024" ><br><br>
